...
```
Even in a small organization like a start-up, a data management system is important to ensure that operations are running properly. At an even larger scale, governments implement a data management system to help gather and redistribute resources to members of the society. Databases are built to maintain information that reflect a complex reality, and this often requires a method of simplifying/generalizing this information which involves decision-making on the part of the technicians. Thus, like anything that is the product of human thinking, data systems are not free of underlying biases. The case discussed by the article, for example, highlights how databases encoding individual’s kinship may be structured following what would be considered the “norm” or “acceptable” social structures. While this would likely capture and reflect the majority of cases, less common/edge cases such as the one talked about in the article would exist. These edge cases become more challenging to deal with as databases expand and become more interconnected, and along with this the repercussions felt by the people considered as the minority/edge cases in these databases will be bigger as they become more excluded. 

As we rely more on information systems to ensure that governments are running, it becomes more important to consider and recognize potential societal biases that may affect how databases are built. Moreover, because societies may change over time, what is considered the norm now may not be the same in 20 years and databases should be built considering those possibilities. Perhaps database development should put more effort into creating a robust system that allow a broader range of permissible elements to be handled or for updates to be made more easily. In any way, it is clear that a more collaborative effort to involve conversations multiple stakeholders (i.e., consultants from government or the general public) is needed when making decisions during the creation of these public databases.
```
